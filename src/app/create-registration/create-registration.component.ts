...
export class CreateRegistrationComponent implements OnInit{
  ...
  submit(){
    ...
    .subscribe(res=>{
      this.NgtoastService.success({detail:"Sucess",summary:"Enquiry added", duration:3000});
  ...
  update(){
    ...
    .subscribe(res=>{
      this.NgtoastService.success({detail:"Sucess",summary:"Enquiry Updated", duration:3000});
      this.registerForm.reset();
